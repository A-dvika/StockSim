...
const Sidebar = ({price, balance, setBalance}) => {
    ...
    const setUserPrice = (priceDirection) => {
    ...
    return (
        <Box className={style.sidebarContainer}>
            ...
            <Grid container sx={{mt: '20%'}} direction={"column"} alignContent={'center'}>
                <Button variant="contained" color="success" onClick={() => setUserPrice('UP')}>
                    Up
                </Button>
                <Paper sx={{
                    width: '224px',
                ...
                <Button variant="contained" color='error' onClick={() => setUserPrice('DOWN')}>Down</Button>
            </Grid>
        </Box>
    );
};
